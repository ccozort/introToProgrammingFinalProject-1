    ...
    def update(self):
        ...
        if abs(player.rect.bottom - self.rect.y) + abs(self.rect.bottom - player.rect.y)  < self.feardistance:
           ...
           self.speedy = 0
            ...
            # print(abs(self.rect.x + self.rect.width - player.rect.x))
        # if abs(player.rect.x + player.rect.width - cheese.rect.x) < self.feardistance:
        #     print(abs(player.rect.x + player.rect.width - cheese.rect.x))
        #     print(abs(self.rect.x + self.rect.width - player.rect.x))
        # if abs(self.rect.x + self.rect.width - player.rect.x) < self.feardistance:
        #     print(abs(player.rect.x + player.rect.width - cheese.rect.x))
        #     print(abs(self.rect.x + self.rect.width - player.rect.x))
        # elif player.rect.x + self.rect.x > self.feardistance:
        #     self.speed = 1
        #     self.rect.x += -self.speed
        # elif player.rect.y - self.rect.y < self.feardistance:
        #     self.speed = 1
